...
class UiTypography {
  ...
  factory UiTypography.standard({
    ...
    return UiTypography(
      ...
      display: base(32, FontWeight.w700, 1.1, -0.8),
      title: base(20, FontWeight.w600, 1.2, -0.5),
      heading: base(16, FontWeight.w600, 1.25, -0.3),
      subheading: base(14, FontWeight.w600, 1.3, -0.1),
      body: base(14, FontWeight.w400, 1.5),
      bodyStrong: base(14, FontWeight.w500, 1.5),
      label: base(12, FontWeight.w500, 1.2, 0.1),
      caption: base(11, FontWeight.w400, 1.3, 0.2),
